    postBodyNode = document.querySelector("div.post-footer");
    
    adsNode1 = document.createElement("div");
    ...
    adsNode2 = document.createElement("div");
    ...
    postBodyNode.prepend(adsNode2);
		postBodyNode.prepend(adsNode1);
